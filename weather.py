...
# --- SIDEBAR SEARCH ENGINE & NAVIGATION (Red line area optimization) ---
st.sidebar.markdown("## 🔍 Live Control Panel")
...
if menu_opt == "🏠 Home Page":
    ...
    st.title("ℹ️ About This Advanced Weather Dashboard")
    st.markdown("""
    Welcome to the **Ultimate Live Weather & Road Dashboard**. This application utilizes high-fidelity 
    ...
    * **Granular Forecasts:** Hourly distribution windows tracking upcoming rainfall probability matrices.
    ...
    st.markdown("""
    This complete ecosystem has been modeled, styled, and compiled by **Karan Roy**. 
...
st.markdown("""
    <div class='footer'>
        © 2026 Karan. All Rights Reserved. | Designed & Developed with ❤️ by Karan Roy
    </div>
""", unsafe_allow_html=True)
